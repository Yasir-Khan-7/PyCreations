...
QuestionBank = ["what does CPU stands for ","what does RAM stands for ","what does GPU stands for "]
name = input("What's your name: ").lower()

Answers =["central processing unit","random access memory","general processing unit"]
